...
public class FakeDatabase {
    ...
    private static final String[] _images = {
        ...
        "http://pre00.deviantart.net/f00e/th/pre/i/2016/005/8/e/162_365_bloodborne_4_by_snatti89-d9mv2qy.png",
        "http://img12.deviantart.net/63ea/i/2015/109/9/7/bloodborne_by_ned_rogers-d7pokca.jpg",
        "http://pre13.deviantart.net/7e2c/th/pre/i/2014/179/e/3/bloodborne_concept_art_by_grobelski-d7obo3v.jpg",
        "http://orig09.deviantart.net/1900/f/2016/013/3/0/ameliamaria1screen2blurpix2sml_by_banished_shadow-d9ns24h.png"};
    ...
    public FakeDatabase() {
        _words = ("The easiest way to get started with Google Custom Search is to create a basic " +
            ...
            "first search engine. Keep it simple so that you can follow what's happening when" +
    ...
    private void createStories(Random random) {
    ...
    private void createStoryFrames(Random random, Story story) {
    ...
    private String getWord(Random random) {
        return _words[random.nextInt(_words.length - 1)];
    }

    private String getSentence(Random random, int minWordCount, int maxWordCount) {
    ...
    private Uri getImage(Random random) {
